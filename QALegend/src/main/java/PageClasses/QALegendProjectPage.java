...
public class QALegendProjectPage 
{
	   ...
	   WebElement prjadded;
		...
		{		
			...
			pageutilities.isElementDisplayed(deletenotification);
			return this;
		}
		public Boolean checkForDeletedProject()
		{
			pageutilities.javaScriptClick(srchbox);
			Boolean msgfound=pageutilities.isElementDisplayed(nodatamsg);
			return msgfound;
		...
		public void searchCompletedProject()
		{
			...
			WaitUtility.waitForVisibilityOfElement(driver, completedstatus);
		}
